...
; ------------------------------------------------------------
	...
	dc.l	_stackTrace		; Exception - Bus Error
	dc.l	_stackTrace		; Exception - Address Error
	dc.l	_stackTrace		; Exception - Illegal Instruction
	dc.l	_stackTrace		; Exception - Division by 0
	dc.l	_nullHandler	; Exception - CHK - Check register against boundaries
	dc.l	_nullHandler	; Exception - TRAPV - Trap on overflow
	dc.l	_stackTrace		; Exception - Privilege violation
	dc.l	_stackTrace		; Exception - Trace
	...
	dc.l	_hBlankHandler	; Interrupt - Level 4 autovector (VDP HBlank)
	dc.l	_nullHandler	; Interrupt - Level 5 autovector
	dc.l	_vBlankHandler	; Interrupt - Level 6 autovector (VDP VBlank)
